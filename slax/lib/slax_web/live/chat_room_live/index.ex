defmodule SlaxWeb.ChatRoomLive.Index do
      ...
      <div class="bg-slate-50 border rounded">
        <div id="rooms" class="divide-y" phx-update="stream">
          ...
          >
            ...
            <button
              class="opacity-0 group-hover:opacity-100 group-focus:opacity-100 focus:opacity-100 bg-white
                hover:bg-gray-100 border border-gray-400 text-gray-700 px-3 py-1.5 w-24 rounded-sm font-bold"
  ...
  def handle_event("toggle-room-membership", %{"id" => room_id}, socket) do
    {room, joined?} =
      room_id
      |> Chat.get_room!()
